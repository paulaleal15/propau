...
<section class="py-5">
    <div class="container px-4 px-lg-5 my-5">
        <div class="row gx-4 gx-lg-5 align-items-center">
            <div class="col-md-6">
                <img class="card-img-top mb-5 mb-md-0" src="{{asset('uploads/productos/'. $producto->imagen) }}" alt="{{$producto->nombre}}"/>
            </div>
            <div class="col-md-6">
                ...
                @if(!$producto->disponible)
                    <div class="alert alert-warning text-center" role="alert">
                        <h4 class="alert-heading">Habitación No Disponible</h4>
                        <p>Esta habitación no se encuentra disponible para reservas en este momento. Por favor, intente con otra habitación.</p>
                    </div>
                @endif

                <form action="{{route('carrito.agregar')}}" method="POST">
                    @csrf
                    <fieldset {{ !$producto->disponible ? 'disabled' : '' }}>
