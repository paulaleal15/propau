...
<div class="card card-outline card-primary">
  <div class="card-header">
    ...
    >
      <h1 class="mb-0"><b>Imperial Suites</b>Gestión Hotelera</h1>
    </a>
  </div>
    ...
    <form action="{{route('registro.store')}}" method="post">
      ...
      <div class="input-group mb-1">
        <div class="form-floating">
          <input id="name" type="text" name="name" value="{{old('name')}}" class="form-control @error('name') is-invalid @enderror" placeholder="Ingrese su nombre" />
      ...
      <div class="input-group mb-1">
        <div class="form-floating">
          ...
          <label for="loginEmail">Correa Electronico</label>
        </div>
        <div class="input-group-text"><span class="bi bi-envelope"></span></div>
        @error('email')
          <div class="invalid-feedback d-block">{{ $message }}</div>
