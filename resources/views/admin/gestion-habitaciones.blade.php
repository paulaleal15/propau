...
<div class="container py-5">
    ...
    <!-- Search and Filters -->
    <form method="GET" action="{{ route('admin.habitaciones') }}">
        <div class="row mb-4">
            <div class="col-md-8">
            ...
            <div class="col-md-4 d-flex justify-content-end">
                <div class="btn-group">
                    <a href="{{ route('admin.habitaciones', ['estado' => 'Todas'] + request()->except('estado')) }}" class="btn btn-outline-secondary filter-btn {{ !request('estado') || request('estado') == 'Todas' ? 'active' : '' }}">
                        Todas ({{ $counts['Todas'] }})
                    </a>
                    <a href="{{ route('admin.habitaciones', ['estado' => 'Disponible'] + request()->except('estado')) }}" class="btn btn-outline-secondary filter-btn {{ request('estado') == 'Disponible' ? 'active' : '' }}">
                        Disponibles ({{ $counts['Disponibles'] }})
                    </a>
                    <a href="{{ route('admin.habitaciones', ['estado' => 'Ocupada'] + request()->except('estado')) }}" class="btn btn-outline-secondary filter-btn {{ request('estado') == 'Ocupada' ? 'active' : '' }}">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    @if($habitacion->estado == 'Disponible')
                                        <li><a class="dropdown-item" href="{{ route('reservar.create', $habitacion) }}">Reservar</a></li>
